...
$siswa_query = "INSERT INTO data_siswa (no_pendaftaran,nama_siswa,ttl,jenis_kel,agama,no_telSiswa,asal_sekolah,alamat_sekolah,jurusan,tanggal,ukuran,gelombang) VALUES ('$noPendaftar', '$namaSiswa', '$ttl', '$jenis','$agama','$notelpSiswa','$asal','$alamatSekolah','$jurusan','$tanggal','$ukuran','$gel')";
